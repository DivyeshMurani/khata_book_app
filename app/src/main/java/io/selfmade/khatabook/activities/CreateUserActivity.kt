...
import io.selfmade.khatabook.databinding.ActivityCreateUserBinding
...
class CreateUserActivity : BaseActivity() {
    ...
    private fun initToolbar() {
        ...
        mToolbar = binding.mToolbarUser.mToolbar
        mToolbar.setTitleTextColor(Color.WHITE)
        mToolbar.title = "Create User"
    ...
    private fun isDone() {
        ...
        if (storeUserProfilePath == "") {
            Constance.showDialog(this@CreateUserActivity, "Select", "Add user profile")
    ...
    private fun submit() {
        ...
        dataViewModel.createUser(applicationContext, createUser)
    ...
    fun createImageFile(): File {
        ...
        val storageDir: File? =
            getAppSpecificAlbumStorageDir(this, Environment.DIRECTORY_PICTURES, "KhataBook")
